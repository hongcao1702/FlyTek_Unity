namespace Second {
    class Unicode {
        public static readonly int[] GB2312ToUnicode ={
                0xA1A1,0x3000,/* '　' -> 12288 */
				0xA1A2,0x3001,/* '、' -> 12289 */
				0xA1A3,0x3002,/* '。' -> 12290 */
				0xA1A4,0x30FB,/* '·' -> 12539 */
        ...
        public static int GetLength() {
            return GB2312ToUnicode.Length;
        }

        public static int DichotomySearch(int value, int high, int low) {
            int middle = 0;
            ...
            int i = GB2312ToUnicode[middle];
            if (GB2312ToUnicode[middle] == value) {
                return middle;
            } else if (GB2312ToUnicode[middle] > value) {
                return DichotomySearch(value, middle - 2, low);
            } else {
                return DichotomySearch(value, high, middle + 2);
            }
        }
    }
}
