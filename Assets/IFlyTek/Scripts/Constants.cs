namespace Second {
    ...
    public class WaveFormat {
        public int mSamplesPerSecond = 16000;               // = 采样率 : 8000 | 6000 | 11025 | 16000
        public short mBitsPerSample = 16;                   // = 量化比特数: 8 | 16
        public short mChannels = 1;                         // = 通道数 : 1
        public short mBlockAlign = 2;                       // = 每采样点字节数 : wBitsPerSample / 8
        public int mAverageBytesPerSecond = 32000;          // = 每秒字节数 : samples_per_sec * bits_per_sample / 8
    }
    ...
    public enum AudioStatus {
        ...
        MSP_AUDIO_SAMPLE_SUPPRESSED = 0x08,
        MSP_AUDIO_SAMPLE_LOST = 0x10,
        MSP_AUDIO_SAMPLE_NEW_CHUNK = 0x20,
        MSP_AUDIO_SAMPLE_END_CHUNK = 0x40,

        MSP_AUDIO_SAMPLE_VALIDBITS = 0x7f /* to validate the value of sample->status */
    }
